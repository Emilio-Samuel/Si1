...
<html>
  ...
  <body>
    ...
    <?php
        ...
        {
    ?>
    <form action = "borraCliente.php" method = "GET">
    ...
    <?php 
            ...
            try {
                ...
                $num_customers = "select count(customers) as numc from customers where customerid = ".$_REQUEST["customerid"];
                $num_orders = "select count(orderid) as numor from orders where customerid = ".$_REQUEST["customerid"];
